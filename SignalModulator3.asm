...
;;; Authors: Joshua Francis & Jayden Grigg    
;;;
...
;===============================================================================
    ...
    movf PORTB, WREG  ; read in value from PORTB.
